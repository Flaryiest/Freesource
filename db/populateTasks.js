...
CREATE TABLE IF NOT EXISTS posts (id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY, user_id INTEGER, title VARCHAR (255), price VARCHAR (255), description VARCHAR(255), tags text ARRAY);
`;
